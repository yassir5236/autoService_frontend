    ...
    <div className="min-h-screen bg-[#E8E8E8] flex items-center justify-center p-8">
      ...
      >
        ...
        <div className="flex flex-col justify-between w-full sm:w-[44%] px-8 sm:px-10 py-8 relative">
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <form className="w-full" onSubmit={handleLogin}>
              ...
              <motion.input
                whileFocus={{ borderColor: "#0A0A0A", boxShadow: "0 0 0 3px rgba(0,0,0,0.05)" }}
                type="email"
              ...
              <motion.input
                ...
                className="w-full text-[13px] px-3.5 py-2.5 rounded-[8px] border border-neutral-200 dark:border-gray-600 bg-white dark:bg-gray-800 outline-none text-black dark:text-white mb-2 transition-all duration-200"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              />
              ...
              <div className="mb-5">
                <Link
                  to="#"
                  className="text-[12px] text-neutral-400 hover:text-black transition-colors duration-150"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  Forgot password?
                </Link>
              ...
              <motion.button type="submit"
                whileHover={{ backgroundColor: "#1a1a1a", scale: 1.01 }}
                whileTap={{ scale: 0.98 }}
          ...
          <p
            className="text-center text-[12px] text-neutral-400 mt-2"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
        ...
        <div className="hidden sm:block flex-1 relative overflow-hidden rounded-r-[18px]">
          {/* Back button overlapping the seam */}
          <motion.div
          ...
          <div className="absolute bottom-4 left-4 right-16 z-10">
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              I booked two high-paying shoots in my first week — more than I'd made in the
              previous month.{" "}
              <span className="font-semibold">
                I'm genuinely blown away and now have too much work!
              </span>
            </p>
            <p
          ...
          <div className="absolute bottom-4 right-3 z-10 flex flex-col gap-1.5">
            {[FiArrowRight, FiArrowLeft].map((Icon, i) => (
              <motion.button
                key={i}
                whileHover={{ scale: 1.1, backgroundColor: "rgba(255,255,255,0.28)" }}
                whileTap={{ scale: 0.93 }}
